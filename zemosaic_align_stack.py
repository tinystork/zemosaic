...
def _apply_winsor_single(args):
    ...
    # ``winsorize`` from scipy.mstats can return a MaskedArray.  Cast back to
    # ndarray so the caller receives the same type as in the single-threaded
    # path.
        ...
        if is_color:
            ...
            if max_workers and max_workers > 1:
                ...
                for c_idx, arr in enumerate(channel_arrays):
                    ...
                    winsorized_list.append(winsorize_func(arr, limits=winsor_limits_tuple, axis=0))
