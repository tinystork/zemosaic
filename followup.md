...
## 0) Branch / commit
- [x] Travailler sur une branche: `fix/gpu-safety-rows-cap-intertile-guardrails`
- [x] 1 commit unique:
  - message: `Fix GPU safety clamp and intertile autotune guardrails`

## 1) Implémentation — GPU safety
### [x] 1.1 Détection “on_battery”
...
### [x] 1.2 Cap adaptatif au lieu de `gpu_rows_per_chunk=128`
...
- [x] Localiser l’endroit où sont fixés `preview` et `min_overlap` pour intertile (là où le log annonce `Using: preview=..., min_overlap=...`).
- [x] Ajouter garde-fou minimal:
